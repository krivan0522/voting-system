...
const AdminPanel = ({ contract, accounts }) => {
    ...
    const registerCandidate = async () => {
        try {
            await contract.methods.registerCandidate(candidateName, candidateParty).send({ from: accounts[0] });
    ...
    return (
        <div style={{ padding: "20px" }}>
            ...
            <Grid container spacing={3}>
                ...
                <Grid item xs={12}>
                    <Button variant="contained" color="primary" onClick={registerCandidate}>
                        Register Candidate
                    </Button>
                </Grid>
